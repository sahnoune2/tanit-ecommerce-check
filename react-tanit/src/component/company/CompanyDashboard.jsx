...
export const CompanyDashboard = (children) => {
  return (
    <div>
      <div className="flex h-screen ">
        {/* Sidebar */}
        <aside className="w-64 bg-gray-900 text-white  w-[20%] ">
          <div className="p-4 border-b border-gray-800">
            <div className="flex items-center justify-between">
              ...
              />
              <span className="text-xl font-bold">Admin company</span>
            </div>
          </div>
          {/* Search Bar */}
          <div className="p-4">
        ...
        <div className="flex-1 p-6 bg-gray-100 w-[80%]">
